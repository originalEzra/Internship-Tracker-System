...
10. Create internship as current user.
11. Get current user's internships.
12. Find internship by id.
13. Update own internship.
14. Delete own internship.
15. Confirm deleted internship returns 404.
16. Confirm no-token request returns 401.
17. Confirm duplicate registration returns 400.
18. Confirm User B cannot access or update User A's internship.
19. Delete current user.
